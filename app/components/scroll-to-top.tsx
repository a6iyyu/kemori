...
export const ScrollToTop: React.FC = () => {
  ...
  return (
    <div
      className={`fixed bottom-8 right-8 grid h-20 w-20 cursor-pointer place-items-center rounded-full bg-gray-50 transition-all duration-300 ease-in-out hover:bg-gray-200 lg:h-24 lg:w-24
