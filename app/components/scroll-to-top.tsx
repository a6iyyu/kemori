...
export const ScrollToTop: React.FC = () => {
  ...
  return (
    <div
      className={`h-[4.5rem] w-[4.5rem] lg:h-24 lg:w-24 grid place-items-center rounded-full bg-gray-50 hover:bg-gray-200 cursor-pointer bottom-8 right-8 transition-all duration-300 ease-in-out ${
