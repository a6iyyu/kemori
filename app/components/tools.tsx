...
export const Tools: React.FC = () => {
  return (
    <>
      ...
      <section className="mx-auto mt-8 grid h-fit w-4/5 grid-cols-1 grid-rows-4 place-items-center justify-between gap-y-10 xl:grid-cols-2 xl:grid-rows-2">
        {menus.map((menu) => (
          <div
            key={menu.id}
            id="tools"
          ...
          >
            <div className="flex h-4/5 w-[85%] flex-col items-start justify-start xl:h-3/4 xl:w-4/5">
